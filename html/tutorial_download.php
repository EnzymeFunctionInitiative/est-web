...
?>
	...
	<h3>Network File Download</h3>
        <p>The network file download page includes two tables.  Each table contains links to download networks, the representative node %ID, the number of nodes, the number of edges, and finally the file size: </p>
...
<form action='tutorial_node_attributes.php' method='post'>
